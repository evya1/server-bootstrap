...
#   release/release-assets.sh required      release files the ml profile needs
...
# What the ml profile needs at runtime. The locks are added from backends.txt.
PROFILE_FILES = (
